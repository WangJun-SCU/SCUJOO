...
public class ContentRecruit extends Activity {
	...
	private String URLCollectDelete = StaticDatas.URL
			+ "scujoo/collect_delete_recruit.php";
	private String URLCollectYny = StaticDatas.URL
			+ "scujoo/collect_yn_recruit.php";
		...
		collect.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (userName.equals("visitor")) {
					Toast.makeText(ContentRecruit.this, "请先登录再收藏", 1).show();
				} else {
	...
	class Yibu extends AsyncTask<String, String, String[]> {
		...
		protected String[] doInBackground(String... params) {
			...
			try {
				...
				System.out.println(httpResponse3.getStatusLine()
						.getStatusCode());
				if (httpResponse3.getStatusLine().getStatusCode() == 200) {
					String result2 = EntityUtils.toString(httpResponse3
							.getEntity());
